...
.run(function($ionicPlatform, $rootScope, $firebaseAuth, $firebase, $window, $ionicLoading, $state, $ionicPopup, $http, $cordovaPush) {
  $ionicPlatform.ready(function() {
    ...
    /*'5L8wEzmhQoGuwRNgVClwsHmg2IekTTH3l2YuGapM','y7q9BblKjZCTmJWp8o7Cs0gfoRVU5rRBdgyLsrCZ'*/
    $rootScope.headers = {
      "X-Parse-Application-Id": "5L8wEzmhQoGuwRNgVClwsHmg2IekTTH3l2YuGapM",
      "X-Parse-REST-API-Key": "noYL3QrheYwuJBfu2jHF9AFZ5gC5dYbClwQ8LyJU",
    ...
    $rootScope.score = 0;
    $rootScope.gifNum = 0;
    $rootScope.baseUrl = 'https://gifasent2.firebaseio.com/';
    $rootScope.list = null;
